...
def planning(goal):
    ...
    # Built up the feedback and the result 
    ...
    if success:
        ...
        # Goal achieved, passing it to result
...
def main():
    ...
    # Construct del server 
    act_s = actionlib.SimpleActionServer(
        '/robot/reaching_goal', exp_assignment2.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
